...
public class PauseManager : MonoBehaviour 
{
    ...
    const string rightTriggerAxis = "SecondaryThumbstick";    //Input mapping for Oculus Touch. Would need remapped for Vive
    const string leftTriggerAxis = "PrimaryIndexTrigger";       //Input mapping for Oculus Touch. Would need remapped for Vive


    bool isRightHand = true;							//Is this sword in the right hand?
